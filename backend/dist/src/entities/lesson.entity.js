...
const student_lesson_progress_entity_1 = require("./student-lesson-progress.entity");
...
], Lesson.prototype, "isLockedByTutor", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => student_lesson_progress_entity_1.StudentLessonProgress, (progress) => progress.lesson),
