...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['monthly', 'yearly', 'lifetime'], default: 'monthly' }),
    __metadata("design:type", String)
], SubscriptionPlan.prototype, "interval", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => user_entity_1.User, (user) => user.subscriptionPlan),
    __metadata("design:type", Array)
], SubscriptionPlan.prototype, "users", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => transaction_entity_1.Transaction, (tx) => tx.subscriptionPlan),
    __metadata("design:type", Array)
], SubscriptionPlan.prototype, "transactions", void 0);
